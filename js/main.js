...
// Primer logro
const getTotalProducts = array => array.length;

let totalProducts = getTotalProducts(productsList);
...
// Último ejercicio
  let computersQuantity = getTotalProducts( computersArray )

console.log( computersQuantity )

let totalComputerPrice = getTotalPrice( computersArray )
